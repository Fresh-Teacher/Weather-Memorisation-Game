(function(cjs, an) {
    ...
    (lib.Mapadebits1 = function() {
        this.spriteSheet = ss["12_memo_clima_atlas_P_"];
        this.gotoAndStop(0);
    ...
    (lib._05 = function(mode, startPosition, loop) {
        ...
        this.instance.setTransform(-44, -50);
        ...
        // Capa 1
        this.instance_1 = new lib.mermoria_carta_tipitocopy();
        this.instance_1.parent = this;
        this.instance_1.setTransform(-50.9, -64.9);

        this.shape = new cjs.Shape();
        this.shape.graphics.f("#4D4D4D").s().p("An9KUQgEAAgDgDQgDgDAAgEIAA0TQAAgEADgDQADgDAEAAIP7AAQAEAAADADQADADAAAEIAAUTQAAAEgDADQgDADgEAAg");
    ...
    (lib._04 = function(mode, startPosition, loop) {
        ...
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#333333").s().p("An9KUQgFAAgDgDQgCgDAAgEIAA0TQAAgEACgDQADgDAFAAIP7AAQAFAAADADQACADAAAEIAAUTQAAAEgCADQgDADgFAAg");
    ...
    (lib._03 = function(mode, startPosition, loop) {
        ...
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#6699CC").s().p("An9KUQgEAAgDgDQgDgDAAgEIAA0TQAAgEADgDQADgDAEAAIP7AAQAEAAADADQADADAAAEIAAUTQAAAEgDADQgDADgEAAg");
    ...
    (lib._02 = function(mode, startPosition, loop) {
        ...
        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#41D9E5").s().p("An8KVQgFgBgDgCQgCgDAAgEIAA0VQAAgEACgDQADgCAFgBIP5AAQAFABADACQACADAAAEIAAUVQAAAEgCADQgDACgFABg");
    ...
    (lib._01 = function(mode, startPosition, loop) {
        ...
        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#908E8F").s().p("An9KUQgEAAgDgDQgDgDAAgEIAA0TQAAgEADgDQADgDAEAAIP7AAQAEAAADADQADADAAAEIAAUTQAAAEgDADQgDADgEAAg");
    ...
    // stage content:
    (lib._12memoclima = function(mode, startPosition, loop) {
        this.initialize(mode, startPosition, loop, {});
        ...
        this.frame_2 = function() {
            ...
            var num_x = 5; //numero de cartas en horizontal
            var num_y = 2; //numero de cartas en vertical
            var num = num_x * num_y; //numero de cartas = 12
            var pos0x = 132; //posicion inicial de la primera carta
            ...
            function onRestart() {
                ...
                cards_init = [this.card1a, this.card1b, this.card2a, this.card2b, this.card3a, this.card3b, this.card4a, this.card4b, this.card5a, this.card5b];
        ...
        this.opciones.setTransform(619.3, 264.3, 1, 1, 30, 0, 0, 64.1, 64);
    ...
    lib.properties = {
        ...
        opacity: 1.00,
        manifest: [{
                src: "images/12_memo_clima_atlas_P_.png",
                id: "12_memo_clima_atlas_P_"
            },
            {
